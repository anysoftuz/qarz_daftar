    ...
    for (var i = 0; i < 7; i++) {
      if (i < widget.graphicStatistics.length) {
        final index1 = widget.graphicStatistics[i].statistics.isNotEmpty
            ? widget.graphicStatistics[i].statistics.first.amount / 1000
            : 0;
        final index2 = widget.graphicStatistics[i].statistics.length == 2
            ? widget.graphicStatistics[i].statistics[1].amount / 1000
            : 0;
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Expanded(
            child: BarChart(
              BarChartData(
                maxY: MyFunction.kattason(widget.graphicStatistics),
